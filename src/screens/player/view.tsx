...
import { TableItem } from '../../global/components/TableItem';
...
export const PlayerView: React.FC<PlayerViewProps> = ({
    ...
    return (
        <S.Container backgroundColor={color.hex}>
            ...
            <S.Table>
                <S.TableRow>
                    <TableItem title="Height" text={`${player.height?.meters}m` || "-"} />
                    <TableItem title="Weight" text={`${player.weight?.kilograms}kg` || "-"} />
                </S.TableRow>
                <S.TableRow>
